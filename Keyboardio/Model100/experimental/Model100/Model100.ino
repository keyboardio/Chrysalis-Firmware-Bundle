...
// This is the "experimental" firmware for the Model100. Essentially the same as
// the default one, with additional plugins on top.
...
// Dynamic (Chrysalis-editable) macros
...
KALEIDOSCOPE_INIT_PLUGINS(
  ...
  // The dynamic macros plugin adds support for Chrysalis-editable macros
  DynamicMacros,
...
void setup() {
  ...
  // Disable SpaceCadet by default
  SpaceCadet.disable();

  // Configure dynamic macros
